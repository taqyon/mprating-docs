...
Дело в том, что популярные [[MarketPlace|маркетплейсы]], такие как Wildberries и Ozon ранжируют [[Article|товарные позиции]] в своей поисковой выдаче, по конкретным параметрам. 
...
>[!cite] Предположение Константина
>
