...
| Ввести [[MarketPlaceSearchResult\|поисковый запрос]] | Клиент вводит необходимый поисковый запрос                     |                            |
| Ввести пол                                           | Клиент указывает пол для выкупа. (М или Ж или М+Ж)             |                            |
| Выбрать размер (если доступно)                       | Размер товара. Подтягивается при вводе артикула в начале формы |                            |
| Выбрать количество выкупов                           |                                                                |                            |
| Выбрать пункт выдачи заказа (ПВЗ)                    |                                                                |                            |
| Оставить комментарий к заказу                        |                                                                |            Нет             |
| Выбрать способ оплаты выкупов                        |                                                                |                            |
